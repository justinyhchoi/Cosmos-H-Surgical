...
if __name__ == '__main__':
    ...
    parser.add_argument('--iou-thres', type=float, default=0.3, help='IoU threshold for validation NMS')
    ...
    # torch.distributed.run (PyTorch 2.x) passes LOCAL_RANK via env var, not --local_rank CLI arg
